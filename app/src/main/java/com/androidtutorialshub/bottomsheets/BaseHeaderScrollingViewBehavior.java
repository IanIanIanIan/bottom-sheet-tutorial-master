 ...
 */
public abstract class BaseHeaderScrollingViewBehavior extends ViewOffsetBehavior<NestedScrollView> {
    ...
    @Override
    public boolean onMeasureChild(CoordinatorLayout parent, NestedScrollView child,
    ...
    @Override
    protected void layoutChild(final CoordinatorLayout parent, final NestedScrollView child,
